...
async function createProperty() {
    ...
    const propertyImagePath = path.join("E:\\Coding\\DEPI Project\\real-state\\real-state\\Designe\\assets\\Images\\Other\\Verona-Navy.jpg");
    ...
    const propertyObject = new Property({
        ...
        authorImg: {
            ...
            contentType: "image/png"    // Set the MIME type for author image
        }
    });
